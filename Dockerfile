...
RUN wget https://github.com/fortio/fortio/releases/download/v1.3.1/fortio_1.3.1-1_amd64.deb && dpkg -i fortio_1.3.1-1_amd64.deb && rm -f fortio_1.3.1-1_amd64.deb
